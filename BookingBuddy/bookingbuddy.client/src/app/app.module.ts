...
@NgModule({
  declarations: [
    ...
    AdInfoStepComponent, PhotosStepComponent,
    FavoriteSidebarComponent, ProfileComponent,
    BookingComponent, FavoritebarPropertyComponent,
    TransactionHandlerComponent, GroupComponent,
    GroupCreateComponent, GroupNameStepComponent,
    GroupMembersStepComponent, FirstStepComponent,
